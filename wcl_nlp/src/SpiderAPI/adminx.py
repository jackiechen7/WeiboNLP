...
class UserInfoAdmin(object):
    ...
    list_filter = ['_id', 'Image', 'NickName', 'Gender', 'Province', 'City', 'BriefIntroduction', 'Birthday',
                   'Constellation',
                   'Num_Tweets', 'Num_Follows', 'Num_Fans', 'SexOrientation', 'Sentiment', 'VIPlevel', 'Authentication',
                   'URL']


class TweetsInfoAdmin(object):
    list_display = ['UserInfo', '_id', 'Content', 'PubTime', 'Co_oridinates', 'Tools', 'Like', 'Comment', 'Transfer',
                    'Content', 'tags', 'pinyin', 'sentiments', 'crawl_time']
    search_fields = ['UserInfo__NickName', '_id', 'Content', 'PubTime', 'Co_oridinates', 'Tools', 'Like', 'Comment',
                     'Transfer', 'Content', 'tags', 'pinyin', 'sentiments', 'crawl_time']
